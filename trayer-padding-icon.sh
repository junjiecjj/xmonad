#! /usr/bin/env bash
#########################################################################
# File Name: trayer-padding-icon.sh
# Author:陈俊杰
# mail: 2716705056@qq.com
# Created Time: 2022年05月23日 星期一 16时47分28秒

# 此程序的功能是：

# https://github.com/ayamir/nord-and-light/blob/master/.config/xmobar/trayer-padding-icon.sh
#########################################################################
